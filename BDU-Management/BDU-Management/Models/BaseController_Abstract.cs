...
{
    public abstract class BaseController_Abstract : Controller
    {
        //Session Methods
        protected void ResetAllSessions()
        {
            HttpContext.Session.Clear();
        }

        //Password Plugin (Bu plugini internetdə tapmışam və bir neçə layihədə istifadə etmişəm)
        ...
        protected class PasswordStorage
        {
